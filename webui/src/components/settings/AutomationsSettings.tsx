...
import { AppsActionButton, SegmentedControl, ToggleButton } from "@/components/settings/settings-primitives";
import type { AutomationAction, AutomationFilter, AutomationSort } from "@/components/settings/SettingsView";
...
export function SimpleAutomationsList({
  jobs,
  loading,
  error,
  onAction,
