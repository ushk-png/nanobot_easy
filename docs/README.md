...
| Using the nanobot-easy fork locally | [`nanobot-easy-usage-ko.md`](./nanobot-easy-usage-ko.md) | Project-local setup, scripts, Telegram, WebUI, and skill registry operations |
